...
function ValidateEmailusr(str)
{
 ...
 {  document.Registration.email.value="";
   ...
   if (checkEmail(emailID.value)==false)
   {
    ...
    document.Registration.email.value=emailID.value;
   return true;			
 }
 catch (e) 
 {
...
function chkPhoneUsr(str)
{	
 var checkOK = " 0123456789-";
 chkData(str,checkOK);
 document.getElementById('mcontact').value = document.getElementById('u_mobile').value;
}

function chkPhoneUsrphone(str)
{	
 var checkOK = " 0123456789-";
 chkData(str,checkOK);
 document.getElementById('contact').value = document.getElementById('u_phone').value;
}

function mNumberLength(str) 
{
